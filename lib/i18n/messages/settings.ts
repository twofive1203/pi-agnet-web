...
export const settingsZh = {
  ...
  workflowSection: "原生 Workflow 面板",
  workflowDescription: "Snail Pi Web 自有开发工作流，任务保存在 .pi/workflows/tasks/，通过 native pi-subagents 的 worker/reviewer 执行实现与检查。与 Trellis 完全独立。",
  enableWorkflow: "启用 Workflow 面板",
  enableWorkflowHint: "开启后右侧会出现 W 按钮；API 也会检查该开关。",
  workflowIncludeArchived: "默认包含已归档任务",
  workflowIncludeArchivedHint: "仅影响面板列表默认筛选。",
  workflowNativeModelsHint: "Workflow 子代理模型仍使用 Settings → Agents 中的 native pi-subagents 配置（settings.json → subagents），不会读取 trellis.subagents。",
...
export const settingsEn = {
  ...
  workflowSection: "Native Workflow panel",
  workflowDescription: "Snail Pi Web-owned development workflow. Tasks live under .pi/workflows/tasks/ and dispatch implement/check through native pi-subagents worker/reviewer. Fully separate from Trellis.",
  enableWorkflow: "Enable Workflow panel",
  enableWorkflowHint: "Shows the W button on the right; APIs also require this setting.",
  ...
  workflowNativeModelsHint: "Workflow agent models still come from Settings → Agents (settings.json → subagents). Workflow never reads trellis.subagents.",
