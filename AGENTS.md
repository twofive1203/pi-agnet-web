...
| Models, native subagents, skills, extensions, auth, usage | `app/api/models*`, `app/api/subagents/config/**`, `app/api/skills/**`, `app/api/pi/**`, `app/api/auth/**`, `app/api/usage/route.ts` | `docs/modules/api.md`, `docs/integrations/README.md` |
...
| Web UI settings (WorkTree, Usage, Web Terminal, ChatGPT panel, Grok panel, Editor, Trellis routing) | `~/.pi/agent/pi-web.json` |
