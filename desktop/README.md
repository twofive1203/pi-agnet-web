...
| Activity tray → **⚙** | Manage the server access key, choose a built-in snail (星海/经典 CSS, 像素 spritesheet) or size, pick a comic bubble palette (奶油白 / 蜜桃粉 / 星夜 / 余烬 / 暮紫 / 墨青), restore default position and medium size, and adjust always-on-top, click-through, login launch, notifications, and sound cues. |
