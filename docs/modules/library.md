...
| `lib/server-access-policy.ts` | Pure policy for Proxy/auth routes: public path allowlist, cookie helpers, effective HTTPS / trusted-proxy rules, same-origin checks. |
