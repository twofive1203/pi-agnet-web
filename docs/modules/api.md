...
| `git/log/` | GET | Revision-bound, bounded Git log page (default 100, max 200) for All or one allowlisted full ref, with literal message/hash-prefix search, canonical author filter, offset pagination, and stale-snapshot rejection. |
