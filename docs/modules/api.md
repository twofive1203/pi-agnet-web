...
| `git/switch/` | POST | Compatibility local-branch switch for the compact panel. Uses common-dir mutation locking, cwd authorization, clean/unmerged/operation-state checks, and linked-worktree branch occupancy validation. |
