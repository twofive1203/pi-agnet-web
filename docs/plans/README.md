...
| [`2026-08-19-001-feat-idea-git-workbench-plan.md`](2026-08-19-001-feat-idea-git-workbench-plan.md) | completed | U1–U8 delivered: standalone IDEA-style refs/All-log/file-tree workbench, authorized common-dir Git boundary, ordinary push and safe commit operations, i18n/docs + disposable repo/worktree/bare-remote smokes. Manual visual matrix remains in `docs/operations/ui-visual-validation.md`. |
| [`2026-08-20-001-fix-tauri-desktop-parity-hardening-plan.md`](2026-08-20-001-fix-tauri-desktop-parity-hardening-plan.md) | completed | Delivered focus-aware notifications, cross-Snapshot sound cooldown, immediate Tray state refresh/left-click reveal, medium/default dock and passive display recovery, stale custom-pet fallback, clean frontend build, and distinct outer/expanded artifact evidence. Windows manual rows remain 未执行; Gate D stays Extend. |
| [`2026-08-21-001-feat-tauri-multi-server-profiles-plan.md`](2026-08-21-001-feat-tauri-multi-server-profiles-plan.md) | completed | U1–U6 delivered: Tauri profile store + DPAPI keys, target/generation connection stack, remote Observer/Control gates, Tauri-only settings UI, switch lifecycle, ADR/docs/package scan. Windows installer/TLS matrix remains manual. |
| [`2026-08-21-002-refactor-web-directory-picker-plan.md`](2026-08-21-002-refactor-web-directory-picker-plan.md) | completed | U1–U5 delivered: native Add Project picker removed, server directory browser is the single path, breadcrumbs/shortcuts/candidate selection/keyboard/responsive layout, docs + cwd-browse/i18n/ui-theme smokes. Browser/manual theme-viewport matrix remains ordinary follow-up. |
| [`2026-08-24-001-fix-session-transcript-after-compaction-plan.md`](2026-08-24-001-fix-session-transcript-after-compaction-plan.md) | completed | U1–U4 delivered: independent display transcript, bounded chat pages, `/transcript` + `view=chat`, compaction markers, entryId merge/scroll restore, docs + targeted smokes. Manual compacted-session browser matrix remains ordinary follow-up. |
| [`2026-08-25-001-feat-inspector-stash-management-plan.md`](2026-08-25-001-feat-inspector-stash-management-plan.md) | completed | U1–U6 delivered: Inspector 工作区/贮藏双页、命名创建、OID 记录与文件 Diff、Apply/Pop/Drop、安全冲突语义、真实 Git smoke、i18n/样式与模块文档。人工主题/viewport 矩阵仍按 UI 验证手册执行。 |
| [`2026-09-17-001-refactor-tauri-desktop-pet-migration-plan.md`](2026-09-17-001-refactor-tauri-desktop-pet-migration-plan.md) | active | U1–U8 code/docs delivered. Gate D is **Extend**: package/isolation/rehearsal harness ready; real NSIS scan, same-machine size/memory, clean-profile, signing, and AE/QS Windows rows remain 未执行. Electron stays the default. |
