...
| [`2026-08-21-002-refactor-web-directory-picker-plan.md`](2026-08-21-002-refactor-web-directory-picker-plan.md) | active | Remove the host-native Add Project picker, unify local/remote behavior on the server directory browser, and improve roots/breadcrumb/selection/keyboard/responsive UX. |
