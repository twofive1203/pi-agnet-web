...
| [`2026-09-17-001-refactor-tauri-desktop-pet-migration-plan.md`](2026-09-17-001-refactor-tauri-desktop-pet-migration-plan.md) | active | Phase A–C code delivered (isolated shell, secure Observer/renderer bridge, settings/secrets/pets, native integrations, quick session). Remaining: U8 package/migration rehearsal/qualification. Electron stays the default. |
