...
| [`2026-08-12-001-feat-desktop-pet-task-observer-plan.md`](2026-08-12-001-feat-desktop-pet-task-observer-plan.md) | active | Independent Windows 10/11 pet + Activity tray; attach to an already running local `spi`, observe Agent/SnFlow/Automation/Quick Command, and show service-not-running guidance without process management. New-session handoff prompts: [`desktop-pet-handoff-prompts.md`](desktop-pet-handoff-prompts.md). |
