...
| [`2026-08-19-001-feat-idea-git-workbench-plan.md`](2026-08-19-001-feat-idea-git-workbench-plan.md) | active | IDEA 风格独立 Git 工作台：refs 树、All 日志过滤、提交文件树，以及无强推/冲突自动中止的安全分支和提交操作。 |
