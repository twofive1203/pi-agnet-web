...
| [`2026-09-17-001-refactor-tauri-desktop-pet-migration-plan.md`](2026-09-17-001-refactor-tauri-desktop-pet-migration-plan.md) | active | Keep Electron intact while an isolated Tauri Preview advances through Windows shell feasibility, secure observer/UI parity, feature migration, and measured release-candidate gates. Electron retirement is explicitly deferred. |
